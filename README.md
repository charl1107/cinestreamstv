...
### 3. Build & Run
1. In the top run configuration dropdown, select **`app-tv`**.
...
- **UI Framework**: Jetpack Compose for TV (`androidx.tv.material3`, `androidx.tv.foundation`) + Android Leanback
